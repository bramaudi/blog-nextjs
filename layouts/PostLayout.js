    ...
    <SectionContainer>
      ...
      <article className="-mx-3">
        <div className="xl:divide-y xl:divide-gray-300 xl:dark:divide-gray-700">
          ...
          <div
            className="pb-8 divide-y divide-gray-300 xl:divide-y-0 dark:divide-gray-700 xl:grid xl:grid-cols-4 xl:gap-x-6"
            style={{ gridTemplateRows: 'auto 1fr' }}
          >
            <dl className="pt-6 pb-10 xl:pt-11 xl:border-b xl:border-gray-300 xl:dark:border-gray-700">
            ...
            <div className="divide-y divide-gray-300 dark:divide-gray-700 xl:pb-0 xl:col-span-3 xl:row-span-2">
            ...
            <footer>
              <div className="text-sm font-medium leading-5 divide-gray-300 xl:divide-y dark:divide-gray-700 xl:col-start-1 xl:row-start-2">
                {tags && (
